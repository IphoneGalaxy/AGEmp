...
- **Próxima fase recomendada (produto):** **Bloco 2 — Conversão Governada de LoanRequest aprovado em Contrato Local** — ADR/plano vivo [`ADR_BLOCO2_CONVERSAO_GOVERNADA.md`](./ADR_BLOCO2_CONVERSAO_GOVERNADA.md) (**proposto**, aguardando aprovação de governança para código); contexto em [`LOANREQUEST_EVOLUTION_ROADMAP.md`](./LOANREQUEST_EVOLUTION_ROADMAP.md). **Sem** contrato automático; **sem** sync financeiro remoto; **Firebase não** como fonte financeira autoritativa. **Bloco2-0** documental **registrado**; **implementação Bloco2-A–E** — **não** iniciada.
...
**Bloco 2 — Conversão Governada de LoanRequest aprovado em Contrato Local** é a **próxima fase recomendada** após o **Bloco 1 funcionalmente fechado** (Opção A). Especificação e subfases: [`ADR_BLOCO2_CONVERSAO_GOVERNADA.md`](./ADR_BLOCO2_CONVERSAO_GOVERNADA.md) (**proposto**); roadmap complementar: [`LOANREQUEST_EVOLUTION_ROADMAP.md`](./LOANREQUEST_EVOLUTION_ROADMAP.md). **Implementação** — **não** iniciada; **próximo passo após aprovação:** **Bloco2-A**. **Sem** contrato automático; confirmação humana de transferência real; revisão antes de criar contrato local; **local-first** e **Firebase não** como fonte financeira autoritativa.
...
| 2026-05-04 | **Bloco2-0:** ADR **proposta** [`ADR_BLOCO2_CONVERSAO_GOVERNADA.md`](./ADR_BLOCO2_CONVERSAO_GOVERNADA.md); implementação **não** iniciada; próximo passo: **Bloco2-A** após aprovação. |
