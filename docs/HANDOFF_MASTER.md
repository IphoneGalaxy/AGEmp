...
**Mini ADR snapshots de nomes — fechada:** [`ADR_IDENTIDADE_PUBLICA_SNAPSHOTS_NOMES.md`](./ADR_IDENTIDADE_PUBLICA_SNAPSHOTS_NOMES.md) §13–§17; commits **`6793461`** … **`28f3f4a`**; QA/smoke § mini ADR em [`QA_MATRIX_LOANREQUEST_V1_1.md`](./QA_MATRIX_LOANREQUEST_V1_1.md). **Próximo recorte recomendado:** **«Visão Fornecedores»** (UX relacionamento por papel). **Referência Bloco 2 (fechado):** [`ADR_BLOCO2_CONVERSAO_GOVERNADA.md`](./ADR_BLOCO2_CONVERSAO_GOVERNADA.md) · **`624c725`** · **`3badcbc`** · **`5dd4c36`** (+ uso snapshot cliente na conversão **`28f3f4a`**) · [`QA_MATRIX_LOANREQUEST_V1_1.md`](./QA_MATRIX_LOANREQUEST_V1_1.md) § Bloco 2. **A2b/A2c** permanecem **backlog** opcional. [`plans/completed/`](./plans/completed/) **só** histórico (ver [`plans/README.md`](./plans/README.md)).
