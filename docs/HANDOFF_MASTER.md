...
**ADR planejada — Financeiro Local do Cliente / «Minhas dívidas»:** [`ADR_FINANCEIRO_LOCAL_CLIENTE_MINHAS_DIVIDAS.md`](./ADR_FINANCEIRO_LOCAL_CLIENTE_MINHAS_DIVIDAS.md) — modelo local **`clientDebtLedger`** separado de **`clients[]`**; Firebase só vínculo/pedido pré-financeiro como contexto; **`calculations.js`** intocado na primeira fase documentada; **implementação não iniciada**.
...
| 2026-05-04 | **ADR planejada — Financeiro Local do Cliente / «Minhas dívidas»:** [`ADR_FINANCEIRO_LOCAL_CLIENTE_MINHAS_DIVIDAS.md`](./ADR_FINANCEIRO_LOCAL_CLIENTE_MINHAS_DIVIDAS.md) — **`clientDebtLedger`** local-first; **`calculations.js`** intocado na primeira fase documentada; **implementação não iniciada**. |
