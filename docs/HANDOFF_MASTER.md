...
- **Bloco 1 (`loanRequests` — operacional):** **funcionalmente fechado** (governança **Opção A**, 2026-05-04). Plano **arquivado** (histórico): [`plans/completed/PLANEJAMENTO_BLOCO1_LOANREQUEST_OPERACIONAL.md`](./plans/completed/PLANEJAMENTO_BLOCO1_LOANREQUEST_OPERACIONAL.md). **Entregue:** **A1a** (`dcc9f80`, `countUnreadLoanRequests` + testes) · **A1b** (`4951bdf`, badges na Conta) · **A2a** (decisões arquivamento por lado, documental — **`8b3cadb`**) · **B1** (métrica **`availableMoney`** / **`calculateGlobalStats`**) · **B2** (`07ef7e5`, alerta não bloqueante no fornecedor). **A2b/A2c** **não** implementadas — **backlog / futuro** (organização por arquivamento); **não** impedem o fechamento funcional. **Próxima fase recomendada:** **Bloco 2 — Conversão Governada de LoanRequest aprovado em Contrato Local** — **fonte viva / ADR proposta:** [`ADR_BLOCO2_CONVERSAO_GOVERNADA.md`](./ADR_BLOCO2_CONVERSAO_GOVERNADA.md) · contexto em [`LOANREQUEST_EVOLUTION_ROADMAP.md`](./LOANREQUEST_EVOLUTION_ROADMAP.md). **Bloco2-0** (ADR/plano documental) **registrado** no repo; **implementação Bloco2-A–E** — **não iniciada** até autorização explícita pós-aprovação do ADR.
...
- **proxima fase recomendada (produto, 2026-05-04):** **Bloco 2** — conversão governada de pedido aprovado em contrato local — [`ADR_BLOCO2_CONVERSAO_GOVERNADA.md`](./ADR_BLOCO2_CONVERSAO_GOVERNADA.md) (proposto; ver roadmap [`LOANREQUEST_EVOLUTION_ROADMAP.md`](./LOANREQUEST_EVOLUTION_ROADMAP.md)); **implementação** — **não** iniciada; **próximo passo documentado:** **Bloco2-A** após aprovação de governança.
...
**Próximo recorte recomendado:** **Bloco 2 — Conversão Governada de LoanRequest aprovado em Contrato Local** — ADR/plano vivo [`ADR_BLOCO2_CONVERSAO_GOVERNADA.md`](./ADR_BLOCO2_CONVERSAO_GOVERNADA.md) (**proposto**, aguardando aprovação para código); roadmap [`LOANREQUEST_EVOLUTION_ROADMAP.md`](./LOANREQUEST_EVOLUTION_ROADMAP.md). **Bloco2-0** documental **presente**; **Bloco2-A–E** **não concluídos**. **A2b/A2c** permanecem **backlog** opcional. [`plans/completed/`](./plans/completed/) **só** histórico (ver [`plans/README.md`](./plans/README.md)).
...
| 2026-05-04 | **Bloco2-0:** ADR/plano vivo **Bloco 2** em [`ADR_BLOCO2_CONVERSAO_GOVERNADA.md`](./ADR_BLOCO2_CONVERSAO_GOVERNADA.md) (**proposto**); implementação **não** iniciada; próximo passo após aprovação: **Bloco2-A**. |
